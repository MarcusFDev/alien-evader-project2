...
export default class GameOver extends Phaser.Scene {
    ...
    create() {
        ...
        if (screenWidth <= 560) {
            this.background = this.add.image(-55, 0, 'gameoverscrmobile').setOrigin(0, 0);
        } else {
            this.background = this.add.image(0, 0, 'gameoverscr').setOrigin(0, 0);
        }
    ...
    // Sets up game over scene elements
    setupGameOver() {
        // Hide elements that are not needed on the game over screen
